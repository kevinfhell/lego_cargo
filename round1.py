...
gyro_straight_forward_print(-13,42,normal_speed)
move_tail_arm_up(90,normal_speed)
mm_motor = MotorPair("A","B")
right_turn_motor(22,normal_speed)
mm_motor = MotorPair("B","A")
gyro_straight_forward_print(0,78,normal_speed)
...
mm_motor.move(8,"degrees",slow_speed)
wait_for_seconds(1)
right_turn_motor(90,slow_speed)
gyro_straight_forward_print(0,188,normal_speed)
